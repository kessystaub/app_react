...
function Perfil() {
  ...
  const updateUser = useCallback(() => {
    ...
    fetch(`https://projeto_1-1-h0551544.deta.app/user/${user.id}`, options)
    .then(data => {
      if (!data.ok) {
  ...
  async function addHardskill(hardskill_id) {
		...
		fetch(`https://projeto_1-1-h0551544.deta.app/user_hardskill`, options)
		.then(data => {
			if (!data.ok) {
				throw Error(data.status);
				}
        ...
        fetch(`https://projeto_1-1-h0551544.deta.app/hardskill/${hardskill_id}`)
            .then(response => response.json())
            .then(data => {
  ...
  async function deleteFormation(formation_id) {
    const novoArrayObjetos = relationsFormation.filter(objeto => objeto.Formation.id !== formation_id);
		axios.delete(`https://projeto_1-1-h0551544.deta.app/user_formation/deleteByUser/${user.id}/${formation_id}`)
		.then(response => {
  ...
  async function deleteExperience(experience_id) {
    ...
    axios.delete(`https://projeto_1-1-h0551544.deta.app/user_experience/deleteByUser/${user.id}/${experience_id}`)
    .then(response => {
      console.log(response);
    })
    .catch(error => {
  ...
  async function deleteSoftskill(softskill_id) {
    const novoArrayObjetos = relationsSoftskill.filter(objeto => objeto.Softskill.id !== softskill_id);
		axios.delete(`https://projeto_1-1-h0551544.deta.app/user_softskill/deleteByUser/${user.id}/${softskill_id}`)
		.then(response => {
  ...
  async function deleteHardskill(tecnicalskill_id) {
    const novoArrayObjetos = relationsHardskill.filter(objeto => objeto.Hardskill.id !== tecnicalskill_id);
		axios.delete(`https://projeto_1-1-h0551544.deta.app/user_hardskill/deleteByUser/${user.id}/${tecnicalskill_id}`)
		.then(response => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response7 = await fetch(`https://projeto_1-1-h0551544.deta.app/softskill`);
        ...
        const response9 = await fetch(`https://projeto_1-1-h0551544.deta.app/hardskill`);
